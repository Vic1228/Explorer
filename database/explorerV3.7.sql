...
CREATE TABLE `spotcomments` (
  ...
  `tripImgName` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- 傾印資料表的資料 `spotcomments`
--

INSERT INTO `spotcomments` (`tripId`, `userId`, `tripMessageTime`, `tripMessageText`, `tripImgName`) VALUES
(2, 4, '2022-03-10 20:45:28', 'test!test!test!', NULL),
(2, 6, '2022-03-12 20:45:28', 'OHNO~~~', NULL),
(2, 6, '2022-03-14 08:21:53', '哈哈', NULL),
(2, 6, '2022-03-14 08:21:58', '真的假的', NULL),
(2, 6, '2022-03-14 08:22:09', '哈哈', NULL);
...
(1, '傑哥', 'dragonnestk@gmail.com', 'a020202', '0912438632', '我是臺灣長跑運動員與創業家。參與完成人類首次橫渡撒哈拉沙漠、世界四大極地超級馬拉松巡迴賽總冠軍、發起擁抱絲路計劃，帶團隊穿越絲路等壯舉。', 1, NULL),
(2, '小芳', 'world1224@gmail.com', 'world1224', '0994736388', '愛出遊', 1, NULL),
(3, '布魯斯', 'hi@gmail.com', 'hi', '0933333333', 'Hi!', 1, NULL),
(4, '查克', 'test@gmail.com', 'test', '0944444444', 'Test!', 1, NULL),
(5, '安德魯', 'oh@gmail.com', 'oh', '0955555555', 'Oh!', 1, NULL),
(6, '艾倫', 'no@gmail.com', 'no', '0966666666', 'No!', 1, NULL),
(7, '德妃雅', 'a020202@gmail.com', '020202', NULL, NULL, 1, NULL),
(8, '艾連納', '123@gmail.com', '123', NULL, NULL, 1, NULL),
(11, '奇多', '456@gmail.com', '456', NULL, NULL, 1, NULL),
(12, '喂李安', '1@gmail.com', '1', NULL, NULL, 1, NULL),
(16, '老吳', '000@000', '000', NULL, NULL, 1, '2022-03-11 11:40:28');
...
(1, 2, 3, 4, 4.7, 4, 4, 2),
(2, 2.5, 3.4, 4, 4.3, 3.2, 4.2, 16),
(3, 2.1, 1.6, 1.8, 2.6, 3.5, 4.2, 7),
(4, 2.2, 3.5, 1.5, 3.1, 3.5, 4.2, 14),
(5, 2.5, 1.2, 3.5, 4.5, 2, 3, 3),
(6, 2.5, 2.7, 2.8, 2.9, 3, 4.7, 4),
(7, 4.3, 3.1, 3.2, 2.7, 2.3, 4.5, 5),
(8, 1.2, 4.4, 4.5, 3.5, 3.3, 2.2, 9),
(11, 3.4, 4.3, 3.7, 2.8, 3.9, 3.3, 12),
(12, 4.7, 1.3, 1.6, 4.3, 2.5, 3.5, 8),
(16, 2.6, 3.4, 3.3, 2.3, 2.5, 2.9, 9);
